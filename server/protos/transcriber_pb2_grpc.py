...
import transcriber_pb2 as transcriber__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in transcriber_pb2_grpc.py depends on'
...
def add_TranscriberServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('transcriber.Transcriber', rpc_method_handlers)
...
class Transcriber(object):
    ...
    def Transcribe(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transcriber.Transcriber/Transcribe',
            transcriber__pb2.VideoRequest.SerializeToString,
            transcriber__pb2.TranscriptReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
